...
arRecKey = Split(key&"", ",")
If UBound(arRecKey) = -1 Then Response.Redirect "newslist.asp"
...
Select Case a
	Case "I": ' Display
		strsql = "SELECT * FROM [news] WHERE " & sqlKey
...
<p><font face="Arial" size="2">Delete from TABLE: news<br><br><a href="newslist.asp">Back to List</a></font></p>
<form action="newsdelete.asp" method="post">
<p>
